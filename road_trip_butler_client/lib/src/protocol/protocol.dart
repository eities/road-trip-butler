...
import 'suggestedStop.dart' as _i3;
...
class Protocol extends _i1.SerializationManager {
  ...
  T deserialize<T>(
    ...
    if (t == _i3.SuggestedStop) {
      return _i3.SuggestedStop.fromJson(data) as T;
    }
    if (t == _i4.Trip) {
    ...
    if (t == _i1.getType<_i3.SuggestedStop?>()) {
      return (data != null ? _i3.SuggestedStop.fromJson(data) : null) as T;
    }
  ...
  static String? getClassNameForType(Type type) {
    return switch (type) {
      ...
      _i3.SuggestedStop => 'SuggestedStop',
      _i4.Trip => 'Trip',
      _ => null,
    };
  }
  ...
  dynamic deserializeByClassName(Map<String, dynamic> data) {
    ...
    if (dataClassName == 'SuggestedStop') {
      return deserialize<_i3.SuggestedStop>(data['data']);
    }
